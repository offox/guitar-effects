...
//altfp_exp CBX_AUTO_BLACKBOX="ALL" DEVICE_FAMILY="Cyclone V" PIPELINE=17 ROUNDING="TO_NEAREST" WIDTH_EXP=8 WIDTH_MAN=23 aclr clock data result
...
module  altfp_exp_ge_altfp_exp_7tc
	( 
	aclr,
	clock,
	data,
...
endmodule //altfp_exp_ge_altfp_exp_7tc
//VALID FILE
...
module altfp_exp_ge (
	...
	altfp_exp_ge_altfp_exp_7tc	altfp_exp_ge_altfp_exp_7tc_component (
				.aclr (aclr),
				.clock (clock),
				.data (data),
				.result (sub_wire0));
...
// Retrieval info: GEN_FILE: TYPE_NORMAL altfp_exp_ge.v TRUE FALSE
// Retrieval info: GEN_FILE: TYPE_NORMAL altfp_exp_ge.qip TRUE FALSE
// Retrieval info: GEN_FILE: TYPE_NORMAL altfp_exp_ge.bsf TRUE TRUE
// Retrieval info: GEN_FILE: TYPE_NORMAL altfp_exp_ge_inst.v TRUE TRUE
// Retrieval info: GEN_FILE: TYPE_NORMAL altfp_exp_ge_bb.v TRUE TRUE
// Retrieval info: GEN_FILE: TYPE_NORMAL altfp_exp_ge.inc TRUE TRUE
// Retrieval info: GEN_FILE: TYPE_NORMAL altfp_exp_ge.cmp TRUE TRUE
